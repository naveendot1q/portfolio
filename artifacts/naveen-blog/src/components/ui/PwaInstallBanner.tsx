  ...
  return (
    <div className="pwa-banner">
      ...
      <div className="flex-1 min-w-0">
        <p className="font-display font-bold text-sm" style={{ color: '#e6edf3' }}>Install NM.DEV Blog</p>
        <p className="text-xs mt-0.5" style={{ color: '#8b949e' }}>Add to home screen for offline reading & quick access</p>
      </div>
